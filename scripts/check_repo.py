...
def validate_text_files() -> list[str]:
    ...
    checks: dict[Path, list[str]] = {
        ...
        REPO_ROOT / "docs" / "testing.md": ["mise run preflight", "mise run deps", "mise run lint", "gh skill publish --dry-run", "scratch project", "docs/install/other-tools.md", "description budget", "overlap", "docs/install/claude-code.md", "docs/install/cursor.md", "plugins/kong-konnect/skills/", ".cursor/plugins/local/kong-konnect"],
