...
user choose. Batch every open point into one round of questions.
...
| "Per seat" | Seats are usage, not a hand-multiplied flat fee. Meter them with an aggregation that reflects the seat count over the period rather than summing events. |
